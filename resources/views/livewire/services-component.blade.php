            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    ...
                    <div class="blog-post-content">
                        ...
                        <p>{{ str_limit(strip_tags($service->description),200,'...')  }}</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    ...
                    <div class="blog-post-content">
                        ...
                        <p>{{ str_limit(strip_tags("An investment is an asset or item acquired with the goal of generating income or appreciation. Appreciation refers to an increase in the value of an asset over time. When an individual purchases a good as an investment, the intent is not to consume the good but rather to use it in the future to create wealth."),200,'...')  }}</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    ...
                    <div class="blog-post-content">
                        ...
                        <p>{{ str_limit(strip_tags("We understand that customer service is a full team effort, not just the responsibility of frontline staff. Indeed, customer experience is every employee’s responsibility and thus we have put in place channels to obtain feedback and communicate with customers. Channels include: call center, customer helplines, e-mail, website, suggestion boxes and complaint/compliment registers in our branches. From time to time, we also carry out customer meetings at branches and customer visitations at their business premises in order to exchange first-hand feedback with our customers."),200,'...')  }}</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-post">
                    ...
                    <div class="blog-post-content">
                        ...
                        <p>{{ str_limit(strip_tags("If you're starting a new business for the first time, you should take every opportunity to give your new enterprise the best chance of success. We provide top business tips and advice to help your business succeed."),200,'...')  }}</p>
